...
Phase: reflect COMPLETE + R19 shipped (v1.23.0). All 21 Cycle-5 findings closed, all batches reflected (net +10). ONLY §4v (FRESH session) then §6a remain — the §4v pack is now generated by scripts/verification-pack.mjs.
